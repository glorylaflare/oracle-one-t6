...
class ConsultaControllerTest {
    ...
    private MockMvc mvc;
    @Autowired
    private JacksonTester<DadosAgendamentoConulta> dadosAgendamentoConultaJacksonTester;
    @Autowired
        ...
        var response = mvc
                .perform(
                        post("/consultas")
                                ...
                                .content(dadosAgendamentoConultaJacksonTester.write(
                                        new DadosAgendamentoConulta(2l,especialidade,5l,data)
                                ).getJson())
                )
                .andReturn().getResponse();
